...
const allProducts = [
  {
    ...
    price: 88.0,
    desc: "Elevate your style to regal heights with our latest masterpiece. Crafted with the utmost precision and adorned with intricate hand embroidery, this collection represents the pinnacle of Moroccan craftsmanship and sophistication. Each piece in this collection is a work of art, meticulously handcrafted by skilled artisans who have honed their craft for generations. The result? A thobe that exudes an aura of opulence, fit for royalty.  It's time to make a statement that truly stands the test of time. ",
    image:
      "https://maghribi.co/cdn/shop/files/KV_09323.jpg?v=1695566213&width=2200",
  },
  {
    id: 0,
    name: "Bespoke Emerald",
...
const makeProductCard = (product) => {
  ...
  div.innerHTML = `
      ...
      <div class="product-details">
        <h4 style="text-align: center;"><a href="${product.id}">${product.name}</a></h4>
